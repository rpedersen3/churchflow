...
class LdsProcessor:
    ...
    def findChurches(self):
        ...
        url = "https://maps.churchofjesuschrist.org/locality/G-ChIJt1YYm3QUQIcR_6eQSTGDVMc"
        driver.get(url)
        ...
        for church in soup.find_all('div', class_ ="store-locator__infobox"):
            ...
            #print("ch: ", church)
            name = church.find('div', class_ ="store-location").get_text(strip=True)
            address = church.find('div', class_ ="store-address").get_text()
            ...
            if foundChurch != None:
                ...
                networkName = "Archdioces of Denver"
